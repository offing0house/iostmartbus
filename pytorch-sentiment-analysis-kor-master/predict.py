...
def predict_cnn(config):
    ...
    pickle_tokenizer = open('./pytorch-sentiment-analysis-kor-master/pickles/tokenizer.pickle', 'rb')
    cohesion_scores = pickle.load(pickle_tokenizer)
    tokenizer = LTokenizer(scores=cohesion_scores)

    pickle_vocab = open('./pytorch-sentiment-analysis-kor-master/pickles/text.pickle', 'rb')
    ...
    print(f'{sentiment_percent*100:.2f} {label}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='버스 운전이 과격해요')
    parser.add_argument('--save_model', type=str, default='./pytorch-sentiment-analysis-kor-master/model.pt')
